local a = {
    custom_script_events = {
        {
            ...
            Events = {
                {Hash = 6969696969, Args = {player.player_id(), 69, 420}},
                {Hash = 420420, Args = {player.player_id(), 666, 1337}}
            }
        }
    },
    ped_assassins = {
        {Name = "Cop", Hash = 0x5E3DA4A4, PedType = 6, Weapon = 0x1D073A89},
        {Name = "Security", Hash = 0xDA2C984E, PedType = 21, Weapon = 0x3656C8C1},
        {Name = "FIB", Hash = 0x5CDEF405, PedType = 27, Weapon = 0x2BE6766B},
        {Name = "Military", Hash = 0xF2DAA2ED, PedType = 29, Weapon = 0xBFEFFF6D},
        {Name = "Juggernaut", Hash = 0x90EF5134, PedType = 26, Weapon = 0x42BF8A85},
        {Name = "Taliban", Hash = 0x4705974A, PedType = 26, Weapon = 0xB1CA77B1},
        {Name = "Transvestite", Hash = 0xE0E69974, PedType = 26, Weapon = 0xAF3696A1},
        {Name = "Clown", Hash = 0x04498DDE, PedType = 26, Weapon = 0x958A4A8F},
        {Name = "Bigfoot", Hash = 0x61D4C771, PedType = 28, Weapon = nil},
        {Name = "Panther", Hash = 0xE71D5E68, PedType = 28, Weapon = nil},
        {Name = "Mountain Lion", Hash = 0x1250D7BA, PedType = 28, Weapon = nil}
    },
    shoot_entitys = {
        {Name = "Boat", Hash = -0x6479D18A},
        {Name = "Bumper Car", Hash = -0x49CEEDE},
        {Name = "XMAS Tree", Hash = 0xE3BA450},
        {Name = "Orange Ball", Hash = 0x8DA1C0E},
        {Name = "Stone", Hash = 0x79C0A750},
        {Name = "Money Bag", Hash = 0x113FD533},
        {Name = "Cash Pile", Hash = -0x11A14369},
        {Name = "Trash", Hash = 0x72654280},
        {Name = "Roller Car", Hash = 0x5C05F6C1},
        {Name = "Cable Car", Hash = -0x2BBD6A23}
    },
    Bodyguards = {
        {
            Name = "Ped Type",
            Children = {
                {Name = "Blackops", Hash = 0x5076A73B},
                {Name = "SWAT", Hash = 0x8D8F1B10},
                {Name = "Agent", Hash = 0xF161D212},
                {Name = "Clown", Hash = 0x04498DDE},
                {Name = "Taliban", Hash = 0x4705974A},
                {Name = "Transvestite", Hash = 0xE0E69974},
                {Name = "Juggernaut", Hash = 0x90EF5134},
                {Name = "Topless", Hash = 2633130371},
                {Name = "Stripper", Hash = 0x81441B71},
                {Name = "Random", Hash = -2},
                {Name = "Clone", Hash = -1}
            }
        },
        {
            Name = "Primary Weapon",
            Children = {
                {Name = "Heavy Rifle", Hash = 0xC78D71B4},
                {Name = "Military Rifle", Hash = 0x9D1F17E6},
                {Name = "Combat MG Mk II", Hash = 0xDBBD7280},
                {Name = "SMG", Hash = 0x2BE6766B},
                {Name = "Carbine Rifle", Hash = 0x83BF0278},
                {Name = "Pump Shotgun Mk II", Hash = 0x555AF99A},
                {Name = "Unholy Hellbringer", Hash = 0x476BF155},
        ...
        },
        {
            ...
            Children = {
                {Name = "Pistol Mk II", Hash = 0xBFE256D4},
                {Name = "AP Pistol", Hash = 0x22D8FE39},
                {Name = "Micro SMG", Hash = 0x13532244},
                {Name = "Pistol .50", Hash = 0x99AEEB3B},
                {Name = "Ceramic Pistol", Hash = 0x2B5EF5EC},
                {Name = "Heavy Revolver MK II", Hash = 0xCB96392F},
                {Name = "Machine Pistol", Hash = 0xDB1AA450},
            ...
            Children = {
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-357.451, -134.309, 38.539),
                            Rotation = v3(0, 0, -20),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(722.985, -1089.206, 23.043),
                            Rotation = v3(0, 0, 0),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-1145.788, -1991.130, 13.163),
                            Rotation = v3(0, 0, 45),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(1178.552, 2646.437, 37.874),
                            Rotation = v3(0, 0, 90),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(112.545, 6619.685, 31.604),
                            Rotation = v3(0, 0, -45),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-208.559, -1308.740, 31.718),
                            Rotation = v3(0, 0, 90),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0x745F3383,
                            Position = v3(-354.170, -96.722, 36.232),
                            Rotation = v3(-90, 0, 150),
                            Freeze = true,
                            Invisible = false
                        }
                    },
            ...
            Children = {
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(924.692, 62.243, 81.210),
                            Rotation = v3(0, 0, 80),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xC42C019A,
                            Position = v3(910.317, 36.022, 80.596),
                            Rotation = v3(0, 0, 25),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(935.786, -0.085, 80.166),
                            Rotation = v3(0, 0, 60),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(964.025, 58.947, 113.343),
                            Rotation = v3(0, 0, -30),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0x745F3383,
                            Position = v3(917.713, 7.888, 78.632),
                            Rotation = v3(-90, 0, 0),
                            Freeze = true,
                            Invisible = false
                        }
            ...
            Children = {
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-81.541, -792.253, 44.622),
                            Rotation = v3(0, 0, 100),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-70.231, -802.176, 44.230),
                            Rotation = v3(0, 0, 0),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-83.269, -773.024, 39.806),
                            Rotation = v3(0, -35, 105),
                            Freeze = true,
                            Invisible = true
                        }
                    },
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-66.390, -813.327, 320.405),
                            Rotation = v3(0, 0, 60),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-66.451, -822.872, 321.197),
                            Rotation = v3(0, 0, 100),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-68.104, -818.675, 323.359),
                            Rotation = v3(0, 90, 0),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-371.32809448242, -1859.2064208984, 21.246929168701),
                            Rotation = v3(0, 15, -75),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xC42C019A,
                            Position = v3(-396.87942504883, -1869.1518554688, 22.718107223511),
                            Rotation = v3(0, 15, -60),
                            Freeze = true,
                            Invisible = true
                        }
            ...
            Children = {
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(335.956, 4834.332, -58.686),
                            Rotation = v3(0, 0, 35),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xC42C019A,
                            Position = v3(326.332, 4827.670, -60.258),
                            Rotation = v3(0, -90, 0),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xAC905876,
                            Position = v3(336.016, 4834.129, -58.0754662),
                            Rotation = v3(-25.160162, 2.82980454e-06, 122.541527),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xAC905876,
                            Position = v3(336.016, 4834.129, -58.9853134),
                            Rotation = v3(-25.160162, 2.82980454e-06, 122.541527),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xAC905876,
                            Position = v3(336.016, 4834.129, -59.5252228),
                            Rotation = v3(-25.160162, 2.82980454e-06, 122.541527),
                            Freeze = true,
                            Invisible = true
                        },
                        {
                            Hash = 0xAC905876,
                            Position = v3(336.016, 4834.129, -57.5355568),
                            Rotation = v3(-25.160162, 2.82980454e-06, 122.541527),
                            Freeze = true,
                            Invisible = true
                        }
                ...
                },
                {
                    ...
                    Objects = {
                        {
                            Hash = 0xC42C019A,
                            Position = v3(128.849, -1298.689, 29.232),
                            Rotation = v3(0, 0, 30),
                            Freeze = true,
                            Invisible = true
                        }
    ...
    vehicle_blacklist = {
        {
            ...
            Children = {
                {Name = "Deluxo", Hash = 0x586765FB},
                {Name = "Scramjet", Hash = 0xD9F0503D},
                {Name = "Vigilante", Hash = 0xB5EF4C33},
                {Name = "Oppressor", Hash = 0x34B82784},
                {Name = "Oppressor Mk II", Hash = 0x7B54A9D3},
                {Name = "Insurgent Pickup", Hash = 0x9114EADA},
                {Name = "Insurgent Pickup Custom", Hash = 0x8D4B7A8A},
                {Name = "Phantom Wedge", Hash = 0x9DAE1398},
                {Name = "Nightshark", Hash = 0x19DD9ED1},
                {Name = "Chernobog", Hash = 0xD6BC7523},
                {Name = "APC", Hash = 0x2189D250},
                {Name = "Rhino", Hash = 0x2EA68690},
                {Name = "Khanjali", Hash = 0xAA6F980A},
                {Name = "Halftrack", Hash = 0xFE141DA6},
                {Name = "Ramp Buggy", Hash = 0xCEB28249},
                {Name = "Ramp Buggy 2", Hash = 0xED62BFA9},
                {Name = "RC Bandito", Hash = 0xEEF345EC},
                {Name = "Mini Tank", Hash = 0xB53C6C52}
            }
        },
        {
            Name = "Air Vehicle Models",
            Children = {
                {Name = "Akula", Hash = 0x46699F47},
                {Name = "Annihilator", Hash = 0x31F0B376},
                {Name = "Buzzard", Hash = 0x2F03547B},
                {Name = "Hunter", Hash = 0xFD707EDE},
                {Name = "Savage", Hash = 0xFB133A17},
                {Name = "Valkyrie", Hash = 0xA09E15FD},
                {Name = "Valkyrie 2", Hash = 0x5BFA5C4B},
                {Name = "Annihilator 2", Hash = 0x11962E49},
                {Name = "Avenger", Hash = 0x81BD2ED0},
                {Name = "Bombushka", Hash = 0xFE0A508C},
                {Name = "Hydra", Hash = 0x39D6E83F},
                {Name = "Lazer", Hash = 0xB39B0AE6},
                {Name = "B-11 Strikeforce", Hash = 0x64DE07A1},
                {Name = "Alkonost", Hash = 0xEA313705}
            }
        },
        {
            Name = "Miscellaneous Models",
            Children = {
                {Name = "Stromberg", Hash = 0x34DBA661},
                {Name = "Toreador", Hash = 0x56C8A5EF},
                {Name = "Patrol Boat", Hash = 0xEF813606},
                {Name = "Weaponized Dinghy", Hash = 0xC58DA34A},
                {Name = "Predator", Hash = 0xE2E7D4AB},
                {Name = "Kosatka", Hash = 0x4FAF0D70}
            }
        }
    },
    entity_spam = {
        {Name = "Wade", Hash = 0x92991B72},
        {Name = "Tracy", Hash = 0xDE352A35},
        {Name = "Amanda", Hash = 0x6D1E15F7},
        {Name = "Prologue Driver", Hash = 0x855E36A3},
        {Name = "Rat", Hash = 0xC3B52966},
        {Name = "Cargoplane", Hash = 0x15F27762},
        {Name = "Volatol", Hash = 0x1AAD0DED},
        {Name = "Dump", Hash = 0x810369E2},
        {Name = "Jet", Hash = 0x3F119114},
        {Name = "Mower", Hash = 0x6A4BD8F6},
        {Name = "Caddy", Hash = 0x44623884},
        {Name = "Fire Truck", Hash = 0x73920F8E},
        {Name = "Bus Stop", Hash = 0x7FACD66F},
        {Name = "Newspaper Thing", Hash = 0xD2EE0584},
        {Name = "Newspaper Thing 2", Hash = 0x4836EEC4},
        {Name = "Fire Hydrant", Hash = 0xBF8AD31},
        {Name = "Street Lights", Hash = 0xC09CB0B8}
    },
    sms_texts = {
        "Fucking bitch",
        "REKT",
    ...
    custom_vehicles = {
        ...
        {
            "Floating Dump",
            {{0xE2E7D4AB, 0x810369E2}, {0xE2E7D4AB, nil, nil, nil, true, nil, nil, nil, nil, nil, 12}, {0x810369E2}}
        },
        {
            "Flying Dump",
            {{0x2F03547B, 0x810369E2}, {0x2F03547B, nil, nil, nil, true, nil, nil, nil, nil, nil, 10, 2}, {0x810369E2}}
        },
        {
            "Submarine Blimp",
            {{0xC07107EE, 0xF7004C86}, {0xC07107EE, nil, nil, nil, true, nil, nil, nil, nil, nil, 20}, {0xF7004C86}}
        },
        {
            "Bandito Tree",
            {
        ...
        {"Attach Tree", {{0xB3B836B0}, {0}, {0xB3B836B0, {0, 0, -0.3}}}},
        {
            "Flying Seamine",
            {{0x58CDAF30, 1039126093}, {0x58CDAF30, nil, nil, nil, nil, nil, nil, nil, nil, nil, 2}, {1039126093}}
        },
        {"Attach Ramp", {{3233397978}, {0}, {3233397978, {0, 4.5, 0.25}, {0, 0, 180}}}},
        {"Attach Invisible Ramp", {{3233397978}, {0}, {3233397978, {0, 4.5, 0.25}, {0, 0, 180}, nil, true}}},
        {"Attach Invisible Ramp 2", {{0x9dae1398}, {0}, {0x9dae1398, {0, -2.25, 0}, nil, nil, true}}},
        {"Attach Invisible Ramp 3", {{0xED62BFA9}, {0}, {0xED62BFA9, {0, 2.25, 0.25}, {-7.5, 0, 0}, nil, true}}},
        {"Sofa Car", {{376180694}, {0, nil, nil, nil, true}, {376180694, {0, -0.2, -0.75}, {0, 0, 180}}}},
        {
        ...
        {
            "Driveable Train",
            {{3471458123, 1030400667}, {3471458123, nil, nil, nil, true, nil, nil, nil, nil, nil, 15}, {1030400667}}
        },
        {
            "Cargoplane XXL",
            {
        ...
        {
            "Driveable Tug Boat",
            {{3471458123, 2194326579}, {3471458123, nil, nil, nil, true, nil, nil, nil, nil, nil, 20}, {2194326579}}
        },
        {
            "Hydra Luxor",
            {{970385471, 3080673438}, {970385471, nil, nil, nil, true, 100, nil, nil, nil, nil, 12}, {3080673438}}
        },
        {
            "XL Tank",
            {
